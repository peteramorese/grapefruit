...
chmod -x /root/task_planner/benchmark/bm_ordered_planner_grid_robot_single_ndfas.py
...
chmod -x /root/task_planner/benchmark/bm_ordered_planner_grid_robot_model_size.py
